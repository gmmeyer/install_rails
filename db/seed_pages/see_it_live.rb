...
step_content = StepContent.create(title: "See It Live", content: html)

previous_steps = Step.joins(:step_content).where("step_contents.title = 'Create Your First App' OR step_contents.title = 'Create Your First App In Windows'")
