...
Edge.create(next_step_id: configure_git_step.id, previous_step_id: install_homebrew_step.id, os_version: "10.9")
Edge.create(next_step_id: configure_git_step.id, previous_step_id: install_homebrew_step.id, os_version: "10.5")
